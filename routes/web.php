...
Route::middleware('auth')->group(function(){
    ...
    Route::delete('/admin/users/{id}', [AdminController::class, 'deleteUser'])->name('user.delete')->middleware('role:admin');

    Route::get('/admin/users/{id}/assign-role', [AdminController::class, 'showAssignRoleForm'])->name('user.assignRole')->middleware('role:admin');
    Route::post('/admin/users/{id}/assign-role', [AdminController::class, 'assignRole'])->name('user.assignRole.submit')->middleware('role:admin');
